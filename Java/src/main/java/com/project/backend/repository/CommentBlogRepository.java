...
//    @Query("select o from comment_in_blog o where o.game.id = ?1")
//   List<CommentBlog> findByGame(Long gameId);
//
//@Query("select o from comment_in_blog o where o.account.id = ?1")
//List<CommentBlog> findByAccount(Long accountId);
//
//@Query("select o from comment_in_blog o where o.blog.id = ?1")
